...
public class ArrCharOps {
    ...
    public static boolean equals(char[] arr1, char[] arr2) {
        ...
        else for (int i = 0; i < arr2.length; i++) {
            if (arr1[i]!=arr2[i]) {
                return false;
            }
        }
    ...
    */
    ...
    public static long hashCode(char[] arr) {
        ...
        for (int i = 0; i < arr.length; i++) {
            ...
            calcCode += arr[i] * Math.pow(7, arr.length-i-1);
    ...
    public static int compareTo(String str1, String str2) {
        ...
        if (str1.length() != str2.length() && str1.length()==smaller) {
            return -1;
        }
        else if (str1.length() != str2.length() && str2.length()==smaller) {
            return 1;
        }
